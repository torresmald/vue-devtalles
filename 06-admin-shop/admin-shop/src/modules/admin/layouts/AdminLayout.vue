<template>
  ...
  <div class="flex w-screen h-screen text-gray-700">
    ...
    <!-- Component Start -->
    <div class="flex flex-col items-center w-16 pb-4 overflow-auto border-r border-gray-300 min-w-[50px]">
      ...
      <a class="flex items-center justify-center flex-shrink-0 w-10 h-10  mt-auto rounded hover:bg-gray-300"
        href="#">
        <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <div class="flex flex-col w-56 border-r border-gray-300">
      ...
      <div class="flex flex-col flex-grow p-4 overflow-auto">
        <RouterLink :to="{name: 'dashboard'}" class="flex items-center flex-shrink-0 h-10 px-2 text-sm font-medium rounded hover:bg-gray-300" href="#">
          <span class="leading-none">Dashboard</span>
        </RouterLink>
        <RouterLink :to="{name: 'products'}" class="flex items-center flex-shrink-0 h-10 px-2 text-sm font-medium rounded hover:bg-gray-300" href="#">
          <span class="leading-none">Products</span>
        </RouterLink>

        <RouterLink class="flex items-center flex-shrink-0 h-10 px-3 mt-auto text-sm font-medium bg-gray-200 rounded hover:bg-gray-300" :to="`/admin/product/create`"
        >
          <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <div class="flex flex-col flex-grow">
      <div class="flex items-center flex-shrink-0 h-16 px-8 border-b border-gray-300">
        <h1 class="text-lg font-medium">Bienvenido: {{ store.fullName }}</h1>
        <button
